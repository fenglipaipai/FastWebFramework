...
import (
	...
	"github.com/hanzhongzi/FastWebFramework-new/framework/gin/binding"
	testdata "github.com/hanzhongzi/FastWebFramework-new/framework/gin/testdata/protoexample"
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/hanzhongzi/FastWebFramework-new/framework/gin.handlerNameTest$", c.HandlerName())
}
